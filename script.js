document.addEventListener('DOMContentLoaded', () => {
    ...
    const lyrics = [
        { time: 0, text: "....." },
        { time: 2, text: "Your Chelseas in Chelsea" },
        { time: 4, text: "Hope that eases the pain, so you remember to miss me" },
        { time: 9, text: "And you sold your car, now you walk for miles" },
        { time: 14.5, text: "Bet your feet feel numb" },
        { time: 15.7, text: "(Crosswalks in my mind are shaky, so please hold on tight)" },
        { time: 20, text: "All my demons run wild" },
        { time: 25, text: "All my demons have your smile" },
        { time: 29.8, text: "In the city of angels, in the city of angels" },
        { time: 39, text: "Hope New York holds you" },
        { time: 44.5, text: "Hope it holds you like I do" },
